...
fp = open('log.txt','w')
subprocess.call('sphinx-apidoc -e -f -o PDSim_apidoc c:\python27\Lib\site-packages\PDSim c:\python27\Lib\site-packages\PDSim\misc\clipper',shell=True,stdout = sys.stdout) 
